...
function Footer(props) {
  return (
    <footer className={`page-footer`} style={{ 'height': '6vh' }} >
      <div className="footer-copyright text-center py-2 bg-dark text-muted d-flex justify-content-between" style={{ 'height': '8vh' }}>
        <p className={style.footerTextLeft}>© 2022 V.A.E.R._comfort </p>
        <p className={style.footerTextCenter}> <NavLink to='/info' className={`nav-link ${style.footerTextCenter}`} >Информация для клиентов</NavLink> </p>
